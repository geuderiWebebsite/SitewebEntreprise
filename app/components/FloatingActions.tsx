...
export default function FloatingActions() {
  ...
  const handleWhatsApp = () => {
    const phoneNumber = '33185490707';
    const text = encodeURIComponent('Bonjour, j\'ai besoin d\'une intervention rapide pour un problème de serrurerie.');
      ...
      {isChatOpen && (
        <Card className="fixed bottom-44 right-6 z-50 w-80 md:w-96 shadow-2xl border-2 border-red-200 animate-fade-in-up">
          <CardHeader className="bg-red-600 text-white rounded-t-lg">
            ...
            <p className="text-sm text-red-100 mt-1">Nous répondons rapidement</p>
          </CardHeader>
