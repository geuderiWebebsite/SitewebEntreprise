...
export default function ClichyContent() {
    ...
    return (
        <div className="min-h-screen bg-white">
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="bg-white p-8 rounded-xl shadow-lg">
                        <div className="grid md:grid-cols-2 gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <div className="bg-orange-50 p-4 rounded-lg mb-4">
                                    ...
                                    <p className="text-gray-600">en moyenne pour Clichy</p>
                                </div>
                        ...
                        <div className="w-full h-64 bg-gray-200 rounded-lg overflow-hidden">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d10490.367855443603!2d2.293830476009904!3d48.90411299604992!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47e66f0c8459badf%3A0x705da473b0136bcb!2sClichy!5e0!3m2!1sfr!2sfr!4v1763134514888!5m2!1sfr!2sfr"
                                width="100%"
                                height="100%"
                                style={{ border: 0 }}
                                allowFullScreen
                        ...
                        <div className="flex items-start space-x-4 mb-6">
                            ...
                            <div>
                                <p className="text-lg italic text-gray-700 mb-4">
                                    &quot;Appelé vers minuit pour une porte claquée à Clichy.
                    ...
                    <div className="grid md:grid-cols-2 gap-12">
                        ...
                        <div className="bg-gradient-to-br from-red-50 to-orange-50 p-8 rounded-xl">
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                />
                                <Input
                                    placeholder="Votre adresse à Clichy"
            ...
            <section className="py-12 px-4 bg-red-700 text-white">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-xl mb-8">
                        Un serrurier se déplace immédiatement à Clichy
                    </p>
                    <a href="tel:0185490707" onClick={handlePhoneClick}>
                        <Button
                            size="lg"
            ...
            <footer className="py-8 px-4 bg-gray-900 text-gray-400 text-center text-sm">
                <p>
                    © 2025 D&apos;Clik Serrure - Serrurier Clichy - Tous droits réservés
                </p>
