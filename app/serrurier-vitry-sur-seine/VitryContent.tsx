...
export default function VitryContent() {
    ...
    return (
        <div className="min-h-screen bg-white">
                ...
                <div className="max-w-4xl mx-auto text-center">
                    <div className="mb-6">
                        <span className="inline-block bg-orange-500 text-white px-4 py-2 rounded-full text-sm font-bold mb-4 animate-pulse">
                            🚨 DISPONIBLE À VITRY-SUR-SEINE
                        </span>
                    </div>
                    <h1 className="text-4xl md:text-6xl font-bold mb-6">
                        Serrurier à Vitry-sur-Seine
                        <br />
            ...
            <section className="py-16 px-4 bg-gray-50">
                <div className="max-w-4xl mx-auto">
                    <h2 className="text-3xl md:text-4xl font-bold text-center mb-8">
                        Zones couvertes à Vitry-sur-Seine
                    </h2>
                    <div className="bg-white p-8 rounded-xl shadow-lg">
                        <div className="grid md:grid-cols-2 gap-6 mb-6">
                            <div>
                                <h3 className="font-bold text-xl mb-4 text-red-700">
                                    Tous les quartiers de Vitry-sur-Seine
                                </h3>
                                <ul className="space-y-2 text-gray-700">
                                    <li>✓ Vitry-sur-Seine Centre-Ville</li>
                                    <li>✓ Clos-Langlois</li>
                                    <li>✓ Commune-de-Paris</li>
                                    <li>✓ Coteau - Malassis</li>
                                </ul>
                            </div>
                            <div>
                                <h3 className="font-bold text-xl mb-4 text-red-700">
                                ...
                                <div className="bg-orange-50 p-4 rounded-lg mb-4">
                                    ...
                                    <p className="text-gray-600">en moyenne pour Vitry-sur-Seine</p>
                                </div>
                        ...
                        <div className="w-full h-64 bg-gray-200 rounded-lg overflow-hidden">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d21028.899233393466!2d2.374499419092997!3d48.78928948878595!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47e67391408a8a49%3A0xdc5c38e751a6eafa!2s94400%20Vitry-sur-Seine!5e0!3m2!1sfr!2sfr!4v1763135412079!5m2!1sfr!2sfr"
                                width="100%"
                                height="100%"
                                style={{ border: 0 }}
                                allowFullScreen
                        ...
                        <div className="flex items-start space-x-4 mb-6">
                            ...
                            <div>
                                <p className="text-lg italic text-gray-700 mb-4">
                                    &quot;Serrurier appelé en urgence, arrivé en 35 minutes à Vitry-sur-Seine.
                                    Ouverture sans casse, prix correct, technicien
                                    très sympa. Je recommande !&quot;
                                </p>
                                <p className="font-bold text-gray-900">
                                    - Karim B., Vitry-sur-Seine
                                </p>
                    ...
                    <div className="grid md:grid-cols-2 gap-12">
                        ...
                        <div className="bg-gradient-to-br from-red-50 to-orange-50 p-8 rounded-xl">
                            <form onSubmit={handleSubmit} className="space-y-4">
                                ...
                                />
                                <Input
                                    placeholder="Votre adresse à Vitry-sur-Seine"
            ...
            <section className="py-12 px-4 bg-red-700 text-white">
                <div className="max-w-4xl mx-auto text-center">
                    ...
                    <p className="text-xl mb-8">
                        Un serrurier se déplace immédiatement à Vitry-sur-Seine
                    </p>
                    <a href="tel:0185490707" onClick={handlePhoneClick}>
                        <Button
                            size="lg"
            ...
            <Faq city="Vitry-sur-Seine" />
            <footer className="py-8 px-4 bg-gray-900 text-gray-400 text-center text-sm">
                <p>
                    © 2025 D&apos;Clik Serrure - Serrurier Vitry-sur-Seine - Tous droits
                    réservés
                </p>
