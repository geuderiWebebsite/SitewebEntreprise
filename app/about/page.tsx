...
import { Shield, Clock, Award, Users, CircleCheck as CheckCircle, Target, Heart, Wrench } from 'lucide-react';
  ...
  const values = [
    {
      icon: Shield,
      title: 'Sécurité',
      description: 'Votre sécurité est notre priorité absolue. Nous utilisons uniquement du matériel certifié.'
    },
    {
      icon: Clock,
      title: 'Rapidité',
      description: 'Intervention en moins de 30 minutes partout à Paris et en Île-de-France.'
    },
    {
      icon: Award,
      title: 'Qualité',
    ...
    },
    {
      icon: Heart,
      title: 'Transparence',
      description: 'Devis gratuit et transparent avant toute intervention. Pas de surprise.'
    }
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="pt-24">
        <section
          ...
          style={{
            backgroundImage: 'linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(https://images.pexels.com/photos/4246120/pexels-photo-4246120.jpeg?auto=compress&cs=tinysrgb&w=1920)',
          }}
        >
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 text-lg text-gray-700 leading-relaxed">
                  <p>
                    Depuis 2009, <span className="font-bold text-red-600">D'Clik Serrure</span> s'est imposée comme
                    la référence en matière de serrurerie à Paris et en Île-de-France. Notre entreprise familiale
                    a été fondée avec une mission simple : offrir un service de serrurerie rapide, fiable et transparent.
                  </p>
                  <p>
                    Au fil des années, nous avons aidé plus de 5000 clients à résoudre leurs problèmes de serrurerie,
                    qu'il s'agisse d'une urgence d'ouverture de porte, d'une installation de serrure haute sécurité,
                    ou d'une simple réparation.
                  </p>
                  <p>
                    Notre équipe de <span className="font-bold text-red-600">serruriers certifiés</span> est disponible
                    24h/24 et 7j/7 pour répondre à tous vos besoins. Nous nous engageons à intervenir rapidement,
                    généralement en moins de 30 minutes, tout en maintenant les plus hauts standards de qualité.
                  </p>
                </div>
              </div>
