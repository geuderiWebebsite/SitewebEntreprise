...
export const SITE_CONFIG = {
  ...
  description:
    "Serrurier Paris professionnel pour dépannage en urgence 24h/24. Ouverture de porte, changement de serrure et installation de sécurité. Intervention rapide sur tout Paris et Île-de-France aux meilleurs tarifs.",
...
export function getDefaultSEO(): SEOPageData {
  return {
    ...
    keywords: [
      ...
      "prix serrurier",
      "ouverture de porte claquee",
      "blindage de porte",
      "artisan serrurier",
      "depannage serrurerie",
      "installation serrure",
      "serrure de securite",
      "reparation porte blindee",
      "sos serrurier"
    ],
