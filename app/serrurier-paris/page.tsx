  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <section className="py-16 px-4 bg-gray-50">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-center mb-8">
              Zones couvertes à Paris
            </h2>
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                <div>
                  <h3 className="font-bold text-xl mb-4 text-red-700">
                    Tous les arrondissements parisiens
                  </h3>
                  <ul className="space-y-2 text-gray-700">
                    <li>✓ Paris 1er - 8ème (Centre, Opéra, Champs-Élysées)</li>
                    <li>✓ Paris 9ème - 16ème (Montmartre, Auteuil, Passy)</li>
                    <li>✓ Paris 17ème - 20ème (Batignolles, Belleville)</li>
                    <li>✓ Paris 11ème - 15ème (Bastille, Tour Eiffel)</li>
                  </ul>
                </div>
                <div>
                  <h3 className="font-bold text-xl mb-4 text-red-700">
                  ...
                  <div className="bg-orange-50 p-4 rounded-lg mb-4">
                    ...
                    <p className="text-gray-600">en moyenne pour Paris intra-muros</p>
                  </div>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              ...
              <div className="bg-gradient-to-br from-red-50 to-orange-50 p-8 rounded-xl">
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  />
                  <Input
                    placeholder="Votre adresse à Paris"
        ...
        <section className="py-12 px-4 bg-red-700 text-white">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8">
              Un serrurier se déplace immédiatement à votre adresse à Paris
            </p>
            <a href="tel:0185490707" onClick={handlePhoneClick}>
              <Button
                size="lg"
        ...
        <footer className="py-8 px-4 bg-gray-900 text-gray-400 text-center text-sm">
          <p>© 2025 D&apos;Clik Serrure - Serrurier Paris - Tous droits réservés</p>
