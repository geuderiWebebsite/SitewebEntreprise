...
import { Phone, Clock, MapPin, AlertTriangle, CheckCircle, Car, Shield } from 'lucide-react';
...
export default function Urgence() {
  const urgencyTypes = [
    ...
    },
    {
      ...
      description: 'Serrure forcée ou endommagée suite à une tentative de cambriolage',
      time: '20-30 min',
      price: '120€'
    },
    {
  ...
  const interventionSteps = [
    {
      ...
      description: 'Contactez-nous au 01 23 45 67 89, nous répondons immédiatement'
    },
    {
      step: '2',
      title: 'Diagnostic Téléphonique',
      description: 'Nous évaluons votre situation et vous donnons un premier tarif'
    },
    {
      step: '3',
    ...
    },
    {
      step: '4',
      title: 'Résolution',
      description: 'Problème résolu rapidement avec garantie sur l\'intervention'
    }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl text-red-100 max-w-3xl mx-auto mb-8">
              Enfermé dehors ? Serrure cassée ? Tentative d'effraction ?
              Nous intervenons en moins de 30 minutes partout à Paris !
            </p>
            <div className="bg-white/10 backdrop-blur-md rounded-lg p-6 max-w-md mx-auto">
              ...
              <Button size="lg" className="bg-orange-500 hover:bg-orange-600 mt-4 w-full animate-bounce hover:animate-none">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {urgencyTypes.map((urgency, index) => {
              ...
              return (
                <Card key={index} className="text-center hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 border-2 border-red-100">
                  <CardHeader>
                    <div className="bg-red-100 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
                      <IconComponent className="h-8 w-8 text-red-600" />
                    </div>
                    <CardTitle className="text-2xl text-gray-900">{urgency.title}</CardTitle>
                  ...
                  <CardContent>
                    <div className="flex justify-between items-center mb-4">
                      <div className="text-center">
                        ...
                        <p className="text-lg font-bold text-blue-700">{urgency.time}</p>
                      </div>
                      <div className="text-center">
                        <p className="text-sm text-gray-600">À partir de</p>
                        <p className="text-lg font-bold text-orange-500">{urgency.price}</p>
                      </div>
                    </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center bg-white p-8 rounded-lg shadow-lg">
              ...
              <p className="text-gray-600">Arrivée garantie en moins de 30 minutes ou intervention gratuite</p>
            </div>
            <div className="text-center bg-white p-8 rounded-lg shadow-lg">
              <CheckCircle className="h-12 w-12 text-green-600 mx-auto mb-4" />
              <h3 className="text-xl font-semibold mb-2">Tarif Transparent</h3>
              <p className="text-gray-600">Prix annoncé au téléphone, pas de surprise sur la facture</p>
            </div>
            <div className="text-center bg-white p-8 rounded-lg shadow-lg">
              <Shield className="h-12 w-12 text-blue-700 mx-auto mb-4" />
              <h3 className="text-xl font-semibold mb-2">Travail Garanti</h3>
              <p className="text-gray-600">Garantie 1 an sur toutes nos interventions d'urgence</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-r from-red-600 to-red-700 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="bg-white/10 backdrop-blur-md rounded-lg p-8 max-w-lg mx-auto">
            <p className="text-5xl font-bold mb-4">01 23 45 67 89</p>
            <p className="text-red-100 mb-6">Disponible 24h/24 - 365 jours par an</p>
            <Button size="lg" className="bg-orange-500 hover:bg-orange-600 text-xl px-12 py-4 animate-pulse hover:animate-none">
